...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    statement = merge(original_df=original_df, modified_df=modified_df, primary_key_columns=primary_key_column, full_merge=False, table=req.form['Table'], schema=req.form['Schema'])
